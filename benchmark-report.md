...
| Key | Value |
| --- | --- |
| Started (UTC) | 2026-04-09T08:15:50.094Z |
| Finished (UTC) | 2026-04-09T08:30:22.304Z |
| Status | success |
| Total Duration (s) | 872.210 |
...
| --- | --- | ---: | ---: | --- |
| Code generation | node .\codegen.js --count 3000 --min-props 100 --max-props 200 --seed orleans-codegen-benchmark | 0 | 2.528 | success |
| GenerateSerializer build | dotnet build .\src\Orleans.CodeGen.Benchmark.GenerateSerializer\Orleans.CodeGen.Benchmark.GenerateSerializer.csproj -c Release | 0 | 791.458 | success |
| Normal build | dotnet build .\src\Orleans.CodeGen.Benchmark.Normal\Orleans.CodeGen.Benchmark.Normal.csproj -c Release | 0 | 78.219 | success |
...
| Target | Time (s) | Calls |
| --- | ---: | ---: |
| CoreCompile | 789.513 | 1 |
| GenerateBuildDependencyFile | 0.164 | 1 |
| Restore | 0.159 | 1 |
| _GenerateRestoreGraph | 0.127 | 1 |
| CopyFilesToOutputDirectory | 0.094 | 1 |
| ResolvePackageAssets | 0.059 | 1 |
| _GetRestoreSettings | 0.058 | 1 |
| _FilterRestoreGraphProjectInputItems | 0.049 | 1 |
| ProcessFrameworkReferences | 0.043 | 2 |
| ResolveAssemblyReferences | 0.036 | 1 |
| SetEmbeddedFilesFromSourceControlManagerUntrackedFiles | 0.035 | 1 |
| InitializeSourceControlInformationFromSourceControlManager | 0.028 | 1 |
| GetCopyToOutputDirectoryItems | 0.019 | 1 |
| ResolveTargetingPackAssets | 0.017 | 1 |
| FindReferenceAssembliesForReferences | 0.014 | 1 |
| GenerateGlobalUsings | 0.010 | 1 |
| AddPrunePackageReferences | 0.009 | 1 |
| UpdateAspNetToFrameworkReference | 0.009 | 2 |
| _LoadRestoreGraphEntryPoints | 0.008 | 1 |
| CoreGenerateAssemblyInfo | 0.007 | 1 |
...
| MSBuild | 0.166 | 7 |
| RestoreTask | 0.158 | 1 |
| GenerateDepsFile | 0.151 | 1 |
| Copy | 0.073 | 2 |
| ResolvePackageAssets | 0.059 | 1 |
| GetRestoreSettingsTask | 0.058 | 1 |
| ProcessFrameworkReferences | 0.038 | 2 |
| ResolveAssemblyReference | 0.035 | 1 |
| Microsoft.Build.Tasks.Git.GetUntrackedFiles | 0.034 | 1 |
| Microsoft.Build.Tasks.Git.LocateRepository | 0.027 | 1 |
| CopyRefAssembly | 0.020 | 1 |
| ResolveTargetingPackAssets | 0.016 | 1 |
| CallTarget | 0.012 | 2 |
| GetPackagesToPrune | 0.009 | 1 |
| WriteLinesToFile | 0.008 | 5 |
| Microsoft.SourceLink.GitHub.GetSourceLinkUrl | 0.007 | 2 |
...
| Target | Time (s) | Calls |
| --- | ---: | ---: |
| CoreCompile | 75.893 | 1 |
| Restore | 0.154 | 1 |
| _GenerateRestoreGraph | 0.125 | 1 |
| _FilterRestoreGraphProjectInputItems | 0.056 | 1 |
| CopyFilesToOutputDirectory | 0.046 | 1 |
| ProcessFrameworkReferences | 0.043 | 2 |
| _GetRestoreSettings | 0.040 | 1 |
| ResolvePackageAssets | 0.030 | 1 |
| InitializeSourceControlInformationFromSourceControlManager | 0.029 | 1 |
| FindReferenceAssembliesForReferences | 0.020 | 1 |
| SetEmbeddedFilesFromSourceControlManagerUntrackedFiles | 0.020 | 1 |
| ResolveAssemblyReferences | 0.016 | 1 |
| GenerateBuildDependencyFile | 0.011 | 1 |
| AddPrunePackageReferences | 0.008 | 1 |
| CheckForDuplicateItems | 0.008 | 1 |
| GetCopyToOutputDirectoryItems | 0.007 | 1 |
| _GenerateCompileDependencyCache | 0.007 | 1 |
...
| MSBuild | 0.165 | 7 |
| RestoreTask | 0.154 | 1 |
| GetRestoreSettingsTask | 0.040 | 1 |
| ProcessFrameworkReferences | 0.038 | 2 |
| Copy | 0.032 | 2 |
| ResolvePackageAssets | 0.030 | 1 |
| Microsoft.Build.Tasks.Git.LocateRepository | 0.027 | 1 |
| Microsoft.Build.Tasks.Git.GetUntrackedFiles | 0.020 | 1 |
| ResolveAssemblyReference | 0.015 | 1 |
| CopyRefAssembly | 0.013 | 1 |
| GenerateDepsFile | 0.010 | 1 |
| GetPackagesToPrune | 0.008 | 1 |
| CheckForDuplicateItems | 0.008 | 3 |
| WriteCodeFragment | 0.007 | 1 |
| WriteLinesToFile | 0.007 | 5 |
| ResolveTargetingPackAssets | 0.006 | 1 |
| CallTarget | 0.006 | 2 |
| Microsoft.SourceLink.GitHub.GetSourceLinkUrl | 0.005 | 2 |
| ResolvePackageFileConflicts | 0.005 | 1 |
...
| --- | ---: | ---: | ---: |
| Build Duration (s) | 791.458 | 78.219 | 713.240 |
| Warnings | 1 | 1 | 0 |
| Errors | 1 | 1 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| CoreCompile | 789.513 | 75.893 | 713.620 | 1 | 1 |
| GenerateBuildDependencyFile | 0.164 | 0.011 | 0.153 | 1 | 1 |
| CopyFilesToOutputDirectory | 0.094 | 0.046 | 0.048 | 1 | 1 |
| ResolvePackageAssets | 0.059 | 0.030 | 0.029 | 1 | 1 |
| ResolveAssemblyReferences | 0.036 | 0.016 | 0.020 | 1 | 1 |
| _GetRestoreSettings | 0.058 | 0.040 | 0.018 | 1 | 1 |
| SetEmbeddedFilesFromSourceControlManagerUntrackedFiles | 0.035 | 0.020 | 0.015 | 1 | 1 |
| GetCopyToOutputDirectoryItems | 0.019 | 0.007 | 0.012 | 1 | 1 |
| ResolveTargetingPackAssets | 0.017 | 0.006 | 0.011 | 1 | 1 |
| _FilterRestoreGraphProjectInputItems | 0.049 | 0.056 | 0.007 | 1 | 1 |
| FindReferenceAssembliesForReferences | 0.014 | 0.020 | 0.006 | 1 | 1 |
| _ComputeUserRuntimeAssemblies | 0.001 | 0.006 | 0.005 | 1 | 1 |
| CheckForDuplicateItems | 0.003 | 0.008 | 0.005 | 1 | 1 |
| Restore | 0.159 | 0.154 | 0.005 | 1 | 1 |
| _GenerateCompileDependencyCache | 0.004 | 0.007 | 0.003 | 1 | 1 |
| _GetCopyToOutputDirectoryItemsFromTransitiveProjectReferences | 0.005 | 0.002 | 0.003 | 1 | 1 |
| GenerateGlobalUsings | 0.010 | 0.007 | 0.003 | 1 | 1 |
| _GenerateSatelliteAssemblyInputs | 0.002 | 0.000 | 0.002 | 1 | 1 |
| CheckForImplicitPackageReferenceOverrides | 0.002 | 0.004 | 0.002 | 2 | 2 |
| GenerateMSBuildEditorConfigFileCore | 0.004 | 0.006 | 0.002 | 1 | 1 |
| _GenerateSourceLinkFile | 0.004 | 0.002 | 0.002 | 1 | 1 |
| _InitializeAzureReposGitSourceLinkUrl | 0.004 | 0.002 | 0.002 | 2 | 2 |
| _GetCopyToOutputDirectoryItemsFromThisProject | 0.004 | 0.002 | 0.002 | 1 | 1 |
| _CleanGetCurrentAndPriorFileWrites | 0.005 | 0.003 | 0.002 | 1 | 1 |
| _GenerateProjectRestoreGraphPerFramework | 0.005 | 0.003 | 0.002 | 1 | 1 |
| _InitializeGitHubSourceLinkUrl | 0.007 | 0.005 | 0.002 | 2 | 2 |
| _GenerateRestoreGraph | 0.127 | 0.125 | 0.002 | 1 | 1 |
| AddGlobalAnalyzerConfigForPackage_MicrosoftCodeAnalysisCSharpCodeStyle | 0.000 | 0.001 | 0.001 | 1 | 1 |
| GetAssemblyVersion | 0.001 | 0.000 | 0.001 | 1 | 1 |
| GetAssemblyAttributes | 0.001 | 0.000 | 0.001 | 1 | 1 |
| GenerateTargetFrameworkDefineConstants | 0.001 | 0.000 | 0.001 | 1 | 1 |
| _CheckForInvalidConfigurationAndPlatform | 0.001 | 0.000 | 0.001 | 1 | 1 |
| ValidateExecutableReferences | 0.001 | 0.000 | 0.001 | 1 | 1 |
| GetTargetPathWithTargetPlatformMoniker | 0.001 | 0.000 | 0.001 | 1 | 1 |
| CollectPackageReferences | 0.002 | 0.001 | 0.001 | 2 | 2 |
| _GetProjectReferenceTargetFrameworkProperties | 0.002 | 0.001 | 0.001 | 1 | 1 |
| _ComputeReferenceAssemblies | 0.002 | 0.001 | 0.001 | 1 | 1 |
| _SetEmbeddedWin32ManifestProperties | 0.003 | 0.004 | 0.001 | 1 | 1 |
| _InitializeGitLabSourceLinkUrl | 0.003 | 0.002 | 0.001 | 2 | 2 |
| _InitializeBitbucketGitSourceLinkUrl | 0.003 | 0.002 | 0.001 | 2 | 2 |
| GenerateNETCompatibleDefineConstants | 0.003 | 0.002 | 0.001 | 1 | 1 |
| CreateGeneratedAssemblyInfoInputsCacheFile | 0.003 | 0.002 | 0.001 | 1 | 1 |
| TranslateBitbucketGitUrlsInSourceControlInformation | 0.003 | 0.004 | 0.001 | 1 | 1 |
| TranslateAzureReposGitUrlsInSourceControlInformation | 0.003 | 0.004 | 0.001 | 1 | 1 |
| ResolveOffByDefaultAnalyzers | 0.004 | 0.003 | 0.001 | 1 | 1 |
| PrepareForBuild | 0.004 | 0.003 | 0.001 | 1 | 1 |
| _CollectTargetFrameworkForTelemetry | 0.005 | 0.006 | 0.001 | 2 | 2 |
| _HandlePackageFileConflicts | 0.005 | 0.006 | 0.001 | 1 | 1 |
| _GetAllRestoreProjectPathItems | 0.006 | 0.007 | 0.001 | 1 | 1 |
| _LoadRestoreGraphEntryPoints | 0.008 | 0.007 | 0.001 | 1 | 1 |
| AddPrunePackageReferences | 0.009 | 0.008 | 0.001 | 1 | 1 |
| InitializeSourceControlInformationFromSourceControlManager | 0.028 | 0.029 | 0.001 | 1 | 1 |
...
| _GenerateRestoreProjectPathItemsPerFramework | 0.001 | 0.001 | 0.000 | 1 | 1 |
| _GenerateRestoreProjectSpec | 0.001 | 0.001 | 0.000 | 1 | 1 |
| _GenerateRestoreSpecs | 0.001 | 0.001 | 0.000 | 1 | 1 |
| CollectPrunePackageReferences | 0.001 | 0.001 | 0.000 | 1 | 1 |
| _GenerateDotnetCliToolReferenceSpecs | 0.001 | 0.001 | 0.000 | 1 | 1 |
...
| AddGlobalAnalyzerConfigForPackage_MicrosoftCodeAnalysisNetAnalyzers | 0.002 | 0.002 | 0.000 | 1 | 1 |
| _SourceLinkHasSingleProvider | 0.002 | 0.002 | 0.000 | 1 | 1 |
| IncrementalClean | 0.002 | 0.002 | 0.000 | 1 | 1 |
...
| TranslateGitLabUrlsInSourceControlInformation | 0.004 | 0.004 | 0.000 | 1 | 1 |
| TranslateGitHubUrlsInSourceControlInformation | 0.004 | 0.004 | 0.000 | 1 | 1 |
| CoreGenerateAssemblyInfo | 0.007 | 0.007 | 0.000 | 1 | 1 |
| ProcessFrameworkReferences | 0.043 | 0.043 | 0.000 | 2 | 2 |

### Shared Slowest Tasks (name-matched)

| Task | GenerateSerializer (s) | Normal (s) | Delta (s) | GenerateSerializer Calls | Normal Calls |
| --- | ---: | ---: | ---: | ---: | ---: |
| Csc | 789.506 | 75.886 | 713.620 | 1 | 1 |
| GenerateDepsFile | 0.151 | 0.010 | 0.141 | 1 | 1 |
| Copy | 0.073 | 0.032 | 0.041 | 2 | 2 |
| ResolvePackageAssets | 0.059 | 0.030 | 0.029 | 1 | 1 |
| ResolveAssemblyReference | 0.035 | 0.015 | 0.020 | 1 | 1 |
| GetRestoreSettingsTask | 0.058 | 0.040 | 0.018 | 1 | 1 |
| Microsoft.Build.Tasks.Git.GetUntrackedFiles | 0.034 | 0.020 | 0.014 | 1 | 1 |
| ResolveTargetingPackAssets | 0.016 | 0.006 | 0.010 | 1 | 1 |
| CopyRefAssembly | 0.020 | 0.013 | 0.007 | 1 | 1 |
| CallTarget | 0.012 | 0.006 | 0.006 | 2 | 2 |
| CheckForDuplicateItems | 0.003 | 0.008 | 0.005 | 3 | 3 |
| RestoreTask | 0.158 | 0.154 | 0.004 | 1 | 1 |
| AllowEmptyTelemetry | 0.004 | 0.001 | 0.003 | 2 | 2 |
| Microsoft.SourceLink.GitHub.GetSourceLinkUrl | 0.007 | 0.005 | 0.002 | 2 | 2 |
| GenerateGlobalUsings | 0.007 | 0.005 | 0.002 | 1 | 1 |
| Microsoft.SourceLink.Common.SourceLinkHasSingleProvider | 0.001 | 0.000 | 0.001 | 1 | 1 |
| JoinItems | 0.001 | 0.000 | 0.001 | 1 | 1 |
| GenerateMSBuildEditorConfig | 0.001 | 0.002 | 0.001 | 1 | 1 |
| CheckForImplicitPackageReferenceOverrides | 0.001 | 0.002 | 0.001 | 2 | 2 |
| GetPackageDirectory | 0.002 | 0.001 | 0.001 | 10 | 10 |
| GetRestorePrunePackageReferencesTask | 0.002 | 0.001 | 0.001 | 1 | 1 |
| GetFrameworkPath | 0.002 | 0.003 | 0.001 | 1 | 1 |
| Hash | 0.002 | 0.003 | 0.001 | 2 | 2 |
| Microsoft.SourceLink.Bitbucket.Git.GetSourceLinkUrl | 0.002 | 0.001 | 0.001 | 2 | 2 |
| Microsoft.SourceLink.AzureRepos.Git.GetSourceLinkUrl | 0.003 | 0.002 | 0.001 | 2 | 2 |
| Microsoft.SourceLink.Common.GenerateSourceLinkFile | 0.003 | 0.002 | 0.001 | 1 | 1 |
| RemoveDuplicates | 0.003 | 0.004 | 0.001 | 7 | 7 |
| ResolvePackageFileConflicts | 0.004 | 0.005 | 0.001 | 1 | 1 |
| WriteCodeFragment | 0.006 | 0.007 | 0.001 | 1 | 1 |
| WriteLinesToFile | 0.008 | 0.007 | 0.001 | 5 | 5 |
| GetPackagesToPrune | 0.009 | 0.008 | 0.001 | 1 | 1 |
| MSBuild | 0.166 | 0.165 | 0.001 | 7 | 7 |
...
| Microsoft.CodeAnalysis.BuildTasks.MapSourceRoots | 0.001 | 0.001 | 0.000 | 1 | 1 |
...
| Microsoft.SourceLink.GitLab.GetSourceLinkUrl | 0.002 | 0.002 | 0.000 | 2 | 2 |
| Microsoft.SourceLink.GitLab.TranslateRepositoryUrls | 0.002 | 0.002 | 0.000 | 1 | 1 |
| MakeDir | 0.003 | 0.003 | 0.000 | 1 | 1 |
| Microsoft.SourceLink.GitHub.TranslateRepositoryUrls | 0.003 | 0.003 | 0.000 | 1 | 1 |
| CheckForDuplicateNuGetItemsTask | 0.003 | 0.003 | 0.000 | 6 | 6 |
| Microsoft.Build.Tasks.Git.LocateRepository | 0.027 | 0.027 | 0.000 | 1 | 1 |
| ProcessFrameworkReferences | 0.038 | 0.038 | 0.000 | 2 | 2 |
